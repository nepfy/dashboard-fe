  ...
  return (
    <div className="grid place-items-center min-h-screen">
      <div className="grid md:grid-cols-2 w-full min-h-screen">
        {/* Blue background - hidden on mobile */}
        <div className="hidden md:block bg-[var(--color-primary-light-400)] flex items-center justify-center">
        ...
        {/* Form container */}
        <div className="flex items-center justify-center p-8 pb-20 sm:p-20">
          <div className="w-full max-w-[480px] space-y-8">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-3 px-4 bg-[var(--color-primary-light-400)] text-white rounded-[var(--radius-s)] font-medium hover:bg-[var(--color-primary-light-500)] transition-colors"
              >
                Criar conta
              </button>
            </form>
