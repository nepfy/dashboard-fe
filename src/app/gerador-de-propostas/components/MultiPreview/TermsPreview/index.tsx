...
import TermsSectionPreview from "./FlashPreview";
      ...
      <>
        <TemplatePreviewWrapper>
          <div className="relative w-full h-full overflow-hidden flex justify-center items-center">
            <div className="w-full h-full overflow-y-scroll flex items-start 2xl:items-center justify-center my-2 p-6 max-w-[1440px]">
