    ...
    return (
      <>
        <TemplatePreviewWrapper>
          <div className="relative w-full h-full overflow-y-scroll flex items-center justify-center">
            <div className="w-full p-6 flex lg:items-start 2xl:items-center justify-center max-w-[1440px]">
