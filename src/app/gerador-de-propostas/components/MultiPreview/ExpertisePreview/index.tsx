...
import ExpertiseSectionPreview from "./FlashPreview";
      ...
      <>
        <TemplatePreviewWrapper>
          <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
            <div className="w-full h-full p-6 overflow-y-scroll flex justify-center items-start 2xl:items-center 2xl:pt-0 max-w-[1440px]">
