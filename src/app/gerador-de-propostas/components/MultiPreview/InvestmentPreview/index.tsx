...
import InvestmentSectionPreview from "./FlashPreview";
      ...
      <>
        <TemplatePreviewWrapper>
          <div className="relative w-full h-full overflow-hidden flex justify-center items-center">
            <div className="w-full h-full flex items-center justify-center p-6 max-w-[1440px]">
          ...
          {formData?.step10?.hideInvestmentSection && (
            <div className="absolute bottom-10 left-6 z-50 hidden p-2 text-sm bg-yellow-light-25 text-white-neutral-light-800 w-[460px] h-[50px] xl:flex items-center justify-center rounded-[10px] border border-yellow-light-50 shadow-lg">
              A seção &quot;Investimento&quot; está atualmente oculta da
              proposta.
            </div>
          )}
