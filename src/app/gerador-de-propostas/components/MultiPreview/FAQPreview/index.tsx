      ...
      <>
        <TemplatePreviewWrapper>
          <div className="relative w-full h-full flex justify-center items-center overflow-hidden">
            <div className="w-full h-full overflow-y-scroll flex items-start 2xl:items-center justify-center p-6 max-w-[1440px]">
              <FAQSectionPreview data={completeProjectData} />
            </div>
          </div>

          {formData?.step14?.hideFaqSection && (
            <div className="absolute bottom-10 left-6 z-50 hidden p-6 text-sm bg-yellow-light-25 text-white-neutral-light-800 w-[460px] h-[50px] xl:flex items-center justify-center rounded-[10px] border border-yellow-light-50 shadow-lg">
