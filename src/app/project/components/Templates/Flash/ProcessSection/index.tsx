    ...
    <>
      {!data?.hideProcessSection && (
        ...
        >
          ...
          <div className="flex items-start lg:items-end justify-start gap-6 lg:gap-12 w-full lg:w-[70%] pr-10 lg:pr-0 mt-20 lg:mt-0">
            <div className="border-l-[0.5px] border-l-[#A0A0A0] h-[231px] lg:h-[360px]" />
            <p className="text-3xl lg:text-7xl text-[#DFD5E1] lg:max-w-[580px] leading-12 lg:leading-22 lg:text-start">
              {" "}
              Como funciona em{" "}
