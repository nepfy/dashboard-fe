        ...
        >
          <div className="px-6 h-[500px] lg:h-[600px] flex flex-col lg:flex-row justify-between items-start">
            {!data?.hideAboutUsSubtitle1 && (
              <p className="max-w-[200px] text-white-neutral-light-100 opacity-50 lg:font-semibold lg:text-sm mb-12 lg:mb-0 mr-0 sm:mr-6 xl:mr-0">
                {data?.aboutUsSubtitle1}
              </p>
            )}

            {!data?.hideAboutUsSubtitle2 && (
              <div className="h-[400px] border-l-[0.5px] border-l-white-neutral-light-100 opacity-50 pl-4 flex items-end">
                <p className="max-w-[750px] min-h-fit text-white-neutral-light-100 font-medium text-lg">
