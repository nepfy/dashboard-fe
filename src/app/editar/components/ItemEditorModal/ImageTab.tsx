...
export default function ImageTab({
  ...
  const introItem =
    itemType === "introServices"
      ? (currentItem as IntroductionService | null)
      : null;
  ...
  return (
    <div className="mb-20 min-h-[351px] space-y-6 sm:mb-0">
      {/* Current image preview for introServices */}
      {itemType === "introServices" && introItem?.image && (
        <div className="rounded-[12px] border border-[#E0E3E9] bg-white p-3 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          <div
            className="relative w-full overflow-hidden rounded-[10px] border border-[#E0E3E9] bg-[#F6F8FA]"
          ...
          {onDeleteItem && (
            <div className="mt-4 flex items-center justify-center">
              <button
                type="button"
                onClick={() => onDeleteItem(introItem.id!)}
                className="flex items-center gap-2 rounded-[8px] border border-red-200 bg-white px-4 py-2 text-sm font-medium text-red-600 transition hover:bg-red-50"
              >
                <svg
                  className="h-4 w-4"
                  fill="none"
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6M9 7h6m-7 0h8a1 1 0 001-1V5a1 1 0 00-1-1h-3.5l-1-1h-3l-1 1H7a1 1 0 00-1 1v1a1 1 0 001 1z"
                  />
                </svg>
                Excluir item
              </button>
