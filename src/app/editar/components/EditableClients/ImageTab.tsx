  ...
  return (
    <>
      <div className="mb-6 flex flex-col gap-6">
        {/* Preview Area */}
        <div className="flex flex-col items-center justify-center gap-4 rounded-lg border border-gray-300 bg-white">
          {currentItem.logo ? (
            ...
            <label
              ...
              ref={iconRef}
              className="h-[120px] w-full cursor-pointer rounded-lg border border-dashed border-gray-300 bg-[#F6F8FA] p-8 text-center transition-colors hover:border-purple-400 hover:bg-purple-50"
            >
