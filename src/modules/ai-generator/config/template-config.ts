  ...
  "plansItems": [
    {
      ...
      "value": "Valor EXATO no formato R$1.000 ou R$2.500 ou R$10.000 (máximo 11 caracteres, SEM CENTAVOS, SEM ESPAÇOS após R$)",
  ...
  "plansItems": [
    {
      ...
      "includedItems": [
        ...
        rules: [
          ...
          "plan.value: formato EXATO R$1.000 ou R$5.500 (≤11 caracteres, SEM CENTAVOS, SEM ESPAÇOS)",
